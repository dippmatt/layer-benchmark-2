...
config = {
    "arguments": {
        "-model": "/home/matthias/Documents/BA/results/models_and_data/image_classification/trained_models/pretrainedResnet_quant.tflite",
        "-input_tensors": "/home/matthias/Documents/BA/results/models_and_data/image_classification/bin_data/all_10_classes_float32.npz",
...
with open("glow_ic_quant_no.json", "w") as config_file:
